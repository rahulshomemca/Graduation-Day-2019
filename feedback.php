...
<div class="container mt-4 p-3">
  ...
  <form class="form-group" action="feedback.php" method="POST">
    ...
    <textarea class="form-control" rows="4" name="feedback"></textarea><br>
    <input type="submit" name="submit" value="Finish" id="finish" class="btn btn-info mt-2" onclick="process();">
    <button id="wait" style="display: none;" class="btn btn-success btn-block">Thank Your ,Please Wait...</button>
  </form>
  </form>
  <?php
    if(isset($_POST['submit']))
    {
      ...
      $id = 'RVCE-GD'.time().rand(1000,9999);
      ...
      if($a1 == '' || $a2 == '' || $a3 == '' || $a4 == '' || $a5 == '')
      {
        ?><p class="text-danger">Please answer all the questions!!</p><?php
      }
      else
      {
        ...
        $body = '<p><b><i>Details Submitted:</i></b></p><p><b>Stud_id</b> : '.$stud_id.'</p><p><b>Name</b> : '.$name.'</p><p><b>Email</b> : '.$email.'</p><p><b>Mobile</b> : '.$mobile.'</p><p><b>USN</b> : '.$usn.'</p><p><b>Attending</b> : '.$attending.'</p><p><b>No. of People Attending</b> : '.$people;
